...
<div class="row row-dd row-dd-relationship">
    ...
    <div class="col-md-12 voyager-relationship-details">
        ...
        <div class="margin_top">
            <label for="extra_options_{{ $relationship['field'] }}">{{ __('voyager.generic.options') }}</label>
            <textarea id="json-input-{{ $relationship['field'] }}" class="resizable-editor" data-editor="json" name="extra_options_{{ $relationship['field'] }}">@if(isset($relationshipDetails->extra_options)){{ $relationshipDetails->extra_options }}@endif</textarea>
